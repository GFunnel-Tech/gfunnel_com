...
function gfHomeSectionHero()
{
    ...
    return '<section class="gfh gfh-hero">'
        ...
        . '<p class="gfh-hero-sub">Communication, tasks, calendar, finance, content, AI automation &mdash; every function of your business in one hub. Your tools come to you.</p>'
        . '<form class="gfh-hero-search" id="gfh-hero-search" action="' . $sSearch . '" method="get" role="search">'
        . '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>'
        . '<input type="text" id="gfh-hero-input" name="keyword" placeholder="Search departments, apps, integrations, guides..." autocomplete="off" aria-label="Search GFunnel" />'
