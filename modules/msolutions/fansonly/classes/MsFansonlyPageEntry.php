...
class MsFansonlyPageEntry extends BxBaseModProfilePageEntry
{
    public function __construct($aObject, $oTemplate = false)
    {
        ...
        //Fix bug: when invalid user profile, error 500
        if($oProfile && method_exists($oProfile, "isActAsProfile") && $oProfile->isActAsProfile()){
            //        if(!$oProfile->isActAsProfile()){
            //do nothing
        }
        ...
        $this->_sCoverClass = 'ms-fansonly-cover-wrapper ' . $this->_oModule->getName() . '_cover';
    }
    ...
    public function getCode ()
    {
        ...
        return ($sRv != '' ? $this->_oModule->_oTemplate->getJsCode('invite_popup', array(
            ...
            'iUserProfileId' => $this->_oProfile->id(),
