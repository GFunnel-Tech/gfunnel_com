...
function MsFansonlyRequests(oOptions) {
    this._sActionsUri = oOptions.sActionUri;
    this._sActionsUrl = oOptions.sActionUrl;
    this._sObjNameGrid = oOptions.sObjNameGrid;
    this._sObjName = oOptions.sObjName == undefined ? 'oMsFansonlyRequests' : oOptions.sObjName;
    this._aHtmlIds = oOptions.aHtmlIds == undefined ? {} : oOptions.aHtmlIds;
    this._oRequestParams = oOptions.oRequestParams == undefined ? {} : oOptions.oRequestParams;
}

MsFansonlyRequests.prototype.onChangeSubscription = function() {
	this.reloadGrid($('#bx-grid-level-' + this._sObjNameGrid).val());
};

MsFansonlyRequests.prototype.reloadGrid = function(iSubscriptionId) {
