...
class MzJobsStudioPage extends BxTemplStudioModule
{
    protected $_sModule;
    protected $_oModule;
    ...
    function __construct($sModule, $mixedPageName, $sPage = "")
    {
        ...
        $this->aMenuItems[BX_DOL_STUDIO_MOD_TYPE_CATEGORIES] = array('name' => BX_DOL_STUDIO_MOD_TYPE_CATEGORIES, 'icon' => 'bars', 'title' => '_mz_jobs_menu_item_title_categories');
    }
