...
function MzJobsForm(oOptions) {
    this._sActionsUri = oOptions.sActionUri;
    this._sActionsUrl = oOptions.sActionUrl;
    this._sObjName = oOptions.sObjName == undefined ? 'oMzJobsForm' : oOptions.sObjName;
...
MzJobsForm.prototype.selectCategory = function(oButton) {   
...
MzJobsForm.prototype.onSelectCategory = function(oData) {
...
MzJobsForm.prototype.checkName = function(oSource, sTitleId, sNameId, iId) {
    var oDate = new Date();
...
MzJobsForm.prototype.loadingInBlock = function(e, bShow) {
    var oParent = $(e).length ? $(e).parents('.bx-db-container:first') : $('body'); 
    bx_loading(oParent, bShow);
};

MzJobsForm.prototype._getDefaultData = function() {
    var oDate = new Date();
