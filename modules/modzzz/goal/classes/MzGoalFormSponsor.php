...
class MzGoalFormSponsor extends BxBaseModTextFormEntry
{
    ...
    function initChecker ($aValues = array (), $aSpecificValues = array())
    {
        ...
        if (!empty($CNF['FIELD_LOCATION_PREFIX']) && isset($this->aInputs[$CNF['FIELD_LOCATION_PREFIX']]) && isset($aValues[$CNF['FIELD_ID']]) && !empty($CNF['OBJECT_METATAGS_SPONSOR']) && ($oMetatags = BxDolMetatags::getObjectInstance($CNF['OBJECT_METATAGS_SPONSOR'])) && $oMetatags->locationsIsEnabled())
