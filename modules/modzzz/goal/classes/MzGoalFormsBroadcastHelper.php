...
class MzGoalFormsBroadcastHelper extends BxBaseModTextFormsEntryHelper
{
    protected $_iEntryId;
    ...
    { 
		...
		$aCollaborators = $this->_oModule->_oDb->getNewsInfoByEntryId($this->_iEntryId);
 
        foreach ($aCollaborators as $aCollaborator) {

			$iRecipient = (int)$aCollaborator[$CNF['FIELD_AUTHOR']];
