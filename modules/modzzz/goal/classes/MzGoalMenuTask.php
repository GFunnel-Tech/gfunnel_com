...
class MzGoalMenuTask extends BxTemplMenu
{
    protected $_sModule;
    protected $_oModule;
    ...
    {
        $this->_aContentInfo = $this->_oModule->_oDb->getTaskInfoById($iContentId);
    ...
    protected function _isVisible ($a)
    {
        ...
        switch ($a['name']) {
            case 'complete-goal-task':
                $sCheckFuncName = 'checkAllowedCompleteTask';
                break;
            case 'fail-goal-task':
                $sCheckFuncName = 'checkAllowedFailTask';
                break;
            case 'edit-goal-task':
                $sCheckFuncName = 'checkAllowedEditTask';
                break; 
            case 'delete-goal-task':
                $sCheckFuncName = 'checkAllowedDeleteTask';
                break; 
        }
