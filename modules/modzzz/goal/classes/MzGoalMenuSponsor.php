...
class MzGoalMenuSponsor extends BxTemplMenu
{
    protected $_sModule;
    protected $_oModule;
    ...
    {
        $this->_aContentInfo = $this->_oModule->_oDb->getSponsorInfoById($iContentId);
    ...
    protected function _isVisible ($a)
    {
        ...
        switch ($a['name']) {
            case 'edit-goal-sponsor':
                $sCheckFuncName = 'checkAllowedEditSponsor';
                break;

            case 'delete-goal-sponsor':
                $sCheckFuncName = 'checkAllowedDeleteSponsor';
                break;
        }
