...
class MzGoalMenuNews extends BxTemplMenu
{
    protected $_sModule;
    protected $_oModule;
    ...
    {
        $this->_aContentInfo = $this->_oModule->_oDb->getNewsInfoById($iContentId);
    ...
    protected function _isVisible ($a)
    {
        ...
        switch ($a['name']) {
            case 'edit-goal-news':
                $sCheckFuncName = 'checkAllowedEditNews';
                break;

            case 'delete-goal-news':
                $sCheckFuncName = 'checkAllowedDeleteNews';
                break;
        }
