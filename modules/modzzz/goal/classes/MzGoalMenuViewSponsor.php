...
class MzGoalMenuViewSponsor extends BxBaseModTextMenu
{
    ...
    public function __construct($aObject, $oTemplate = false)
    {
		...
		if($sPageUri==$CNF['URI_CREATE_SPONSOR'])
		{
			$this->setContentId($iContentId); 
		}else{
			$this->_aSponsorInfo = $this->_oModule->_oDb->getSponsorInfoById($iContentId); 
			$this->setContentId($this->_aSponsorInfo[$CNF['FIELD_GOAL_ID']]);  
		}
    }
