...
function MzGoalForm(oOptions) {
    this._sActionsUri = oOptions.sActionUri;
    this._sActionsUrl = oOptions.sActionUrl;
    this._sObjName = oOptions.sObjName == undefined ? 'oMzGoalForm' : oOptions.sObjName;
...
MzGoalForm.prototype.selectCategory = function(oButton) {   
...
MzGoalForm.prototype.onSelectCategory = function(oData) {
...
MzGoalForm.prototype.checkName = function(oSource, sTitleId, sNameId, iId) {
    var oDate = new Date();
...
MzGoalForm.prototype.loadingInBlock = function(e, bShow) {
    var oParent = $(e).length ? $(e).parents('.bx-db-container:first') : $('body'); 
    bx_loading(oParent, bShow);
};

MzGoalForm.prototype._getDefaultData = function() {
    var oDate = new Date();
