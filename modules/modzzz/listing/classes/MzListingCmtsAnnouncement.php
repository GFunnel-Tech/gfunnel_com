...
class MzListingCmtsAnnouncement extends BxTemplCmts
{
    protected $_sModule;
    protected $_oModule;
    ...
    public function isPostReplyAllowed ($isPerformAction = false)
    {
        ...
        $aAnnouncement = $this->_oModule->_oDb->getAnnouncementInfoById($this->getId());

        $mixedResult = BxDolService::call($this->_aSystem['module'], 'check_allowed_comments_post', array($aAnnouncement['entry_id'], $CNF['OBJECT_COMMENTS']));
