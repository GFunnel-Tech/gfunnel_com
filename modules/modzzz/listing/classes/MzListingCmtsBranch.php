...
class MzListingCmtsBranch extends BxTemplCmts
{
    protected $_sModule;
    protected $_oModule; 
    ...
    public function isPostReplyAllowed ($isPerformAction = false)
    {
        ...
        $aBranch = $this->_oModule->_oDb->getBranchInfoById($this->getId());

        $mixedResult = BxDolService::call($this->_aSystem['module'], 'check_allowed_comments_post', array($aBranch['entry_id'], $CNF['OBJECT_COMMENTS']));
