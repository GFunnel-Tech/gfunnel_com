...
class MzListingMenuViewSchedule extends BxBaseModTextMenu
{
    ...
    public function __construct($aObject, $oTemplate = false)
    {
		...
		$iContentId = bx_process_input(bx_get('id'), BX_DATA_INT);
 		...
 		if($sPageUri==$CNF['URI_CREATE_SCHEDULE'])
		{
			$this->setContentId($iContentId); 
		}else{
			$this->_aMenuInfo = $this->_oModule->_oDb->getScheduleInfoById($iContentId); 
