...
class MzListingMenuViewReward extends BxBaseModTextMenu
{
    ...
    public function __construct($aObject, $oTemplate = false)
    {
		...
		if($sPageUri==$CNF['URI_CREATE_REWARD'])
		{
			$this->setContentId($iContentId); 
		}else{
			$this->_aRewardInfo = $this->_oModule->_oDb->getRewardInfoById($iContentId); 
			$this->setContentId($this->_aRewardInfo[$CNF['FIELD_LISTING_ID']]);  
		}
    }
