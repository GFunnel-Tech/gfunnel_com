...
class MzListingCmtsSchedule extends BxTemplCmts
{
    protected $_sModule;
    protected $_oModule;
    ...
    public function isPostReplyAllowed ($isPerformAction = false)
    {
        ...
        $aSchedule = $this->_oModule->_oDb->getScheduleInfoById($this->getId());

        $mixedResult = BxDolService::call($this->_aSystem['module'], 'check_allowed_comments_post', array($aSchedule['entry_id'], $CNF['OBJECT_COMMENTS']));
