...
class MzListingMenuAnnouncement extends BxTemplMenu
{
    protected $_sModule;
    protected $_oModule;
    ...
    {
        $this->_aContentInfo = $this->_oModule->_oDb->getAnnouncementInfoById($iContentId);
    ...
    protected function _isVisible ($a)
    {
        ...
        switch ($a['name']) {
            case 'edit-listing-announcement':
                $sCheckFuncName = 'checkAllowedEditAnnouncement';
                break;

            case 'delete-listing-announcement':
                $sCheckFuncName = 'checkAllowedDeleteAnnouncement';
                break; 
        }
