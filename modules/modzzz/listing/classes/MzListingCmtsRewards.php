...
class MzListingCmtsRewards extends BxTemplCmts
{
    protected $_sModule;
    protected $_oModule;
    ...
    public function isPostReplyAllowed ($isPerformAction = false)
    {
        ...
        $aReward = $this->_oModule->_oDb->getRewardInfoById($this->getId());

        $mixedResult = BxDolReward::call($this->_aSystem['module'], 'check_allowed_comments_post', array($aReward['entry_id'], $CNF['OBJECT_COMMENTS']));
