...
class MzListingCmtsServices extends BxTemplCmts
{
    protected $_sModule;
    protected $_oModule;
    ...
    public function isPostReplyAllowed ($isPerformAction = false)
    {
        ...
        $aService = $this->_oModule->_oDb->getServiceInfoById($this->getId());

        $mixedResult = BxDolService::call($this->_aSystem['module'], 'check_allowed_comments_post', array($aService['entry_id'], $CNF['OBJECT_COMMENTS']));
