...
class MzListingMenuService extends BxTemplMenu
{
    protected $_sModule;
    protected $_oModule;
    ...
    {
        $this->_aContentInfo = $this->_oModule->_oDb->getServiceInfoById($iContentId);
    ...
    protected function _isVisible ($a)
    {
        ...
        switch ($a['name']) {
            case 'edit-listing-service':
                $sCheckFuncName = 'checkAllowedEditService';
                break;

            case 'delete-listing-service':
                $sCheckFuncName = 'checkAllowedDeleteService';
                break;
        }
