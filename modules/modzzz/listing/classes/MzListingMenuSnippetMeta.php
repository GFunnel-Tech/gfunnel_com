...
class MzListingMenuSnippetMeta extends BxBaseModTextMenuSnippetMeta
{
    ...
    protected function _getMenuItemCategory($aItem)
    {
		...
		if($iCategory){
			$this->_sCategoryUrl = bx_absolute_url(BxDolPermalinks::getInstance()->permalink($CNF['URL_SUBCATEGORIES'], array($CNF['GET_PARAM_SUBCATEGORY'] => ''))); 
        }else{
