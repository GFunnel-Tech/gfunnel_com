...
class MzListingMenuViewGift extends BxBaseModTextMenu
{
    ...
    public function __construct($aObject, $oTemplate = false)
    {
		...
		if($sPageUri==$CNF['URI_CREATE_GIFT'])
		{
			$this->setContentId($iContentId); 
		}else{
			$this->_aGiftInfo = $this->_oModule->_oDb->getGiftInfoById($iContentId); 
			$this->setContentId($this->_aGiftInfo[$CNF['FIELD_LISTING_ID']]);  
		}
    }
