...
class MzListingMenuReward extends BxTemplMenu
{
    protected $_sModule;
    protected $_oModule;
    ...
    {
        $this->_aContentInfo = $this->_oModule->_oDb->getRewardInfoById($iContentId);
    ...
    protected function _isVisible ($a)
    {
        ...
        switch ($a['name']) {
            case 'edit-listing-reward':
                $sCheckFuncName = 'checkAllowedEditReward';
                break;

            case 'delete-listing-reward':
                $sCheckFuncName = 'checkAllowedDeleteReward';
                break;
        }
