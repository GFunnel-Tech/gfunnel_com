...
class MzListingMenuSchedule extends BxTemplMenu
{
    protected $_sModule;
    protected $_oModule;
    ...
    {
        $this->_aContentInfo = $this->_oModule->_oDb->getScheduleInfoById($iContentId);
    ...
    protected function _isVisible ($a)
    {
        ...
        switch ($a['name']) {
            case 'edit-listing-schedule':
                $sCheckFuncName = 'checkAllowedEditSchedule';
                break;

            case 'delete-listing-schedule':
                $sCheckFuncName = 'checkAllowedDeleteSchedule';
                break; 
        }
