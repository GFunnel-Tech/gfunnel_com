...
class MzListingMenuClaim extends BxTemplMenu
{
    protected $_sModule;
    protected $_oModule;
    ...
    {
        $this->_aContentInfo = $this->_oModule->_oDb->getClaimInfoById($iContentId);
    ...
    protected function _isVisible ($a)
    {
        ...
        switch ($a['name']) {
            case 'edit-listing-claim':
                $sCheckFuncName = 'checkAllowedEditClaim';
                break;

            case 'delete-listing-claim':
                $sCheckFuncName = 'checkAllowedDeleteClaim';
                break;
        }
