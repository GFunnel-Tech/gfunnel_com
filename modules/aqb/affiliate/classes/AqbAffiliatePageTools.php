 ...
 */
class AqbAffiliatePageTools extends BxBaseModGroupsPageBrowse
{
    ...
    public function getCode(){
        ...
        $this->_oModule->_oTemplate->addCss(array('profile.css', 'program.css', 'affiliate.css', 'tools.css', 'main.css'));
