...
// Step 1: Retrieve all new profile IDs from the sys_accounts table where MemberID is empty
$result = $connection->query("SELECT profile_id FROM sys_accounts WHERE MemberID IS NULL OR MemberID = ''");

if ($result->num_rows > 0) {
    // Step 2: Loop through each new profile ID
